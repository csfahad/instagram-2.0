...
function Modal() {
  ...
  const uploadPost = async () => {
    ...
    // 3) upload the image to firebse storage with the post ID
      ...
      >
        <div className="flex min-h-[800px] items-end justify-center px-4 pt-4 pb-20 text-center sm:block sm:min-h-screen sm:p-0">
          ...
          <Transition.Child
            ...
            leaveTo="opacity-0 translate-y-4 sm:translate-y-0 sm:scale-195"
          >
              ...
              <div>
                ...
                <div className="mt-5 sm:mt-6">
                  <button
                    ...
                    type="button"
                    className="disabled:cursor inline-flex w-full cursor-not-allowed justify-center rounded-md border border-transparent bg-red-600 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 disabled:bg-gray-300 hover:disabled:bg-gray-300 sm:text-sm"
                  >
